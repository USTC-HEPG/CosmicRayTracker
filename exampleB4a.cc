...
int main(int argc,char** argv)
{
  ...
  for ( G4int i=1; i<argc; i=i+2 ) {
    ...
    if      ( arg == "-m" ) macro = argv[i+1];
      ...
      G4cout << "Stopped at argument "<< i << G4endl;
      PrintUsage();
      return 1;
    }
  }  
  ...
  Config* config = new Config(energy, randomize, doPlot, doHist, true/*Pos*/, false/*Angle*/);
  ...
  B4aActionInitialization* actionInitialization
     = new B4aActionInitialization(detConstruction, config);
